...
def get_split_dataset(dset_name, batch_size, n_worker, val_size, data_root='../data',
    ...
    if dset_name == 'cifar10':
        ...
        # if os.path.exists("./logs/dataloaderStore/dataLoader_Store.pkl"):
        #     with open('./logs/dataloaderStore/dataLoader_Store.pkl', 'rb') as f:
        #     # The protocol version used is detected automatically, so we do not
        #     # have to specify it.
        #         store = pickle.load(f)
        #     train_loader,val_loader,n_class = store
        # else:
        ...
        # store = [train_loader, val_loader, n_class]
    
        # with open("./logs/dataloaderStore/dataLoader_Store.pkl","wb") as f:
        #     pickle.dump(store,f)
    else:
        raise NotImplementedError
